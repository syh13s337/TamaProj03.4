...
public class DBTamaGUILogIn {
	...
	private DBTamaGUICreateUser tgcu;
	private DBTamaGUILogIn tgli;
	private DBMySQLEngine mysql;
	
	public void loginStarter(GameEngine ge,DBTamaGUILogIn tgli, DBUserEngine ue, DBMySQLEngine mysql){
		this.ge = ge;
		this.tgli = tgli;
		this.ue = ue;
		this.mysql = mysql;
...
//		frameLogIn.getContentPane().setForeground(Color.WHITE);
	...
	private void btnCreateUser(){
		if (tgcu==null){
			tgcu = new DBTamaGUICreateUser(ge, tgli, ue, tgcu);
